  ...
  _createClass(HLayoutItem, [{
    ...
    value: function render() {
      ...
      if (align === 'stretch') {
        return _react2['default'].createElement(
          ...
          _extends({}, this.props, props, {
            className: (0, _util.joinClassNames)(this.props.className, 'appLayoutGrowChildFlex')
          }),
          this.props.children
        );
      }
      ...
      return _react2['default'].createElement(
        'div',
        _extends({}, this.props, props, {
          className: (0, _util.joinClassNames)(this.props.className, this.props.height ? 'appLayoutGrowChildStatic' : null)
        }),
        this.props.children
      );
    }
